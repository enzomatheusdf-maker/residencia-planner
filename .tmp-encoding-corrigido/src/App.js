...
export default function App() {
  ...
  // â”€â”€â”€ GARANTIR FLUSH ANTES DE SAIR DA PÃGINA â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  useEffect(() => {
    if (!usuarioLogado) return;
  ...
  const checkWorkloadAndWarn = useCallback(() => {
    ...
    if (exceeds) {
      return window.confirm(
        "Sua próxima semana já está cheia de revisões. Adicionar tema novo agora pode te soterrar — quer mesmo continuar?"
      );
    }
    return true;
  }, [plat]);
  ...
  const handleFocusModeCompleteStep = useCallback(
    (temaId, stepKey, markData) => {
      ...
      if (stepKey === "d1") {
        ...
        showToast("âœ“ Tema iniciado com sucesso!");
      } else {
        pushUndo(plat);
        ...
        showToast(`âœ“ Etapa computada com sucesso!`, true);
      }
      ...
      if (gamifAfter.freezesOwned < gamifBefore.freezesOwned) {
        ...
        setTimeout(() => {
          showToast(`â„ï¸ Ofensiva Protegida! Mentor: "${text}"`, false, 6000);
        }, 1500);
          ...
          <div className="flex items-center gap-4">
            ...
            {!focusMode && (
              <div className="flex items-center gap-2">
                ...
                {syncStatus === 'saved' && <span className="w-2 h-2 rounded-full bg-emerald-500" title="Sincronizado com nuvem âœ“" />}

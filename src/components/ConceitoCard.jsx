        ...
        <div className="px-4 pb-5 pt-1 border-t border-white/5 space-y-4 animate-fade-in text-left">
          ...
          <div className="flex bg-black/40 border border-white/5 rounded-xl p-1 gap-1">
            {[
              ...
              { id: "L2", label: "L2 • Como?", icon: GraduationCap, color: "text-blue-400" },
              { id: "L3", label: "L3 • Por Quê?", icon: BookOpen, color: "text-sky-400" }
            ].map(layer => {
          ...
          <div className="min-h-[120px] transition-all duration-300">
                ...
                <div className="space-y-2">
                  {l2.map((step, idx) => (
                    <div key={idx} className="flex items-start gap-3 bg-white/[0.01] border border-white/5 p-3 rounded-xl hover:bg-white/[0.02] transition-all">
                      <span className="flex items-center justify-center w-5 h-5 rounded-full bg-blue-600/20 text-blue-400 text-[10px] font-black shrink-0 mt-0.5 font-mono">
                        {idx + 1}
                      </span>
            ...
            {activeLayer === "L3" && (
              <div className="space-y-2.5 animate-fade-in">
                <div className="flex items-start gap-2.5 bg-sky-500/5 border border-sky-500/10 p-3.5 rounded-xl">
                  <BookOpen className="text-sky-400 shrink-0 mt-0.5" size={16} />
                  <div className="space-y-1">

...
export const DOMAIN_TEST_RECOMMENDATIONS = {
  consolidated: {
    ...
    message: "Tema consolidado. Voce nao precisa reestudar agora. Vamos apenas manter esse tema vivo com revisao leve.",
  },
  rescue: {
    status: "rescue_needed",
    conduta: "revisao_dirigida_mais_questoes",
    message: "Tema parcialmente lembrado. Faca uma revisao dirigida e resolva novas questoes antes de avancar.",
  },
  treat_as_new: {
    status: "treat_as_new",
    conduta: "d0_normal",
    message: "Esse tema ainda nao esta seguro. Ele voltara como tema novo no plano.",
  },
  fragile_base: {
    status: "fragile_base",
    conduta: "revisao_conceitual_curta",
    message: "Voce acertou parte das questoes, mas sua estrutura conceitual esta fragil. Faca uma revisao curta antes de marcar como dominado.",
  },
  detail_noise: {
    status: "detail_noise",
    conduta: "registrar_padrao_de_erro",
    message: "Os erros parecem concentrados em detalhes. Registre o padrao, mas evite criar excesso de cards.",
  },
};

export const DOMAIN_TEST_AGENDA_META = {
  consolidated: {
    agendaLabel: "Dominio consolidado",
    stepLabel: "D21 leve",
    taskLabel: "Revisar D21",
    mentorTitle: "Manter dominio consolidado",
    mentorSubtitle: "Teste de Dominio validou base e questoes.",
    mentorReason: "Tema consolidado nao deve voltar como D0.",
    mentorExplain: "Manter revisao leve protege memoria sem reabrir estudo inicial.",
    mentorCta: "Revisar leve",
    detailRecommendation: "Revisao leve: nao reabra D0; preserve o tema vivo no D21/manutencao.",
  },
  rescue: {
    agendaLabel: "Resgate dirigido",
    stepLabel: "Resgate",
    taskLabel: "Revisao dirigida",
    mentorTitle: "Resgate dirigido",
    mentorSubtitle: "Teste de Dominio apontou lembranca parcial.",
    mentorReason: "65-79% ou base parcial pede revisao dirigida antes de avancar.",
    mentorExplain: "Foque lacunas do Brain Dump e refaca questoes antes de liberar o ciclo normal.",
    mentorCta: "Fazer resgate",
    detailRecommendation: "Revisao dirigida: corrija lacunas do Brain Dump e resolva novo bloco curto de questoes.",
  },
  treat_as_new: {
    ...
    mentorSubtitle: "Teste de Dominio nao sustentou dominio previo.",
    mentorReason: "Abaixo de 65% entra no plano como D0 normal.",
    mentorExplain: "Trate como aquisicao: pre-teste, estudo guiado, Brain Dump e questoes.",
    mentorCta: "Estudar D0",
    detailRecommendation: "Tema novo: execute D0 completo antes de contar revisao espacada.",
  },
  fragile_base: {
    agendaLabel: "Revisao conceitual",
    stepLabel: "Conceitual",
    taskLabel: "Revisao conceitual",
    mentorTitle: "Revisao conceitual curta",
    mentorSubtitle: "Acerto sem estrutura conceitual segura.",
    mentorReason: "Brain Dump fraco impede falso dominio mesmo com questoes razoaveis.",
    mentorExplain: "Reconstrua definicao, mecanismo, red flags e conduta antes de novas questoes.",
    mentorCta: "Revisar base",
    detailRecommendation: "Revisao conceitual: reconstrua a base do tema antes de seguir para questoes.",
  },
  detail_noise: {
    agendaLabel: "Padrao de erro",
    stepLabel: "Padrao",
    taskLabel: "Revisar padrao",
    mentorTitle: "Revisar padrao de erro",
    mentorSubtitle: "Erros concentrados em detalhes.",
    mentorReason: "Erro por detalhe pede log e ajuste de prova, nao explosao de cards.",
    mentorExplain: "Registre gatilhos de detalhe e faca bloco curto de questoes sem criar cards infinitos.",
    mentorCta: "Revisar padrao",
    detailRecommendation: "Padrao de erro: registre o gatilho e evite criar excesso de cards.",
  },
};
